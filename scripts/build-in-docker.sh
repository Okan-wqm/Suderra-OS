...
for name in \
    ...
    SUDERRA_RELEASE_TIER \
    SUDERRA_RELEASE_VERSION \
    SUDERRA_SIGNING_MODE \
    SUDERRA_SOURCE_SHA \
    SUDERRA_SOURCE_RUN_ID \
    SUDERRA_PKCS11_ENGINE \
    SUDERRA_PKCS11_MODULE \
    SUDERRA_FIT_SIGNING_KEY \
    SUDERRA_FIT_SIGNING_CERT \
    SUDERRA_FIT_KEYS_DIR \
    SUDERRA_IMAGE_SIGNING_KEY \
    SUDERRA_IMAGE_SIGNING_CERT \
    SUDERRA_SECUREBOOT_SIGNING_KEY \
    SUDERRA_SECUREBOOT_SIGNING_CERT \
    SUDERRA_HSM_SIGNING_EVIDENCE \
    SUDERRA_RAUC_PKCS11_URI \
    SUDERRA_RAUC_SIGNING_KEY \
    SUDERRA_RAUC_SIGNING_CERT \
    SUDERRA_RAUC_KEYRING
do
    add_extra_env "${name}"
done
