...
- Production-candidate release input yalnızca
  ...
  semantic guest facts ve mutation artifact before/after hash taşır. Scenario
  runner plan değerini pass/fail JSON'una kopyalamaz; komutun yazdığı
  `scenario-result.json` ölçümünü kullanır.
